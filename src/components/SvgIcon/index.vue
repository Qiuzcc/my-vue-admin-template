<template>
    <div v-if="isExternal" v-on="$listener" class="svg-external-icon svg-icon" :style="styleExternalIcon"></div>
    <svg v-else :class="svgClass" aria-hidden="true" v-on="$listener">
